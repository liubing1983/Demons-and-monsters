...
public class GisThrift {

  public interface Iface {

    public String test(int id, String name) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void test(int id, String name, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_test(int id, String name) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void test(int id, String name, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      test_call method_call = new test_call(id, name, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class test_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int id;
      private String name;
      public test_call(int id, String name, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class test<I extends Iface> extends org.apache.thrift.ProcessFunction<I, test_args> {
      ...
      public test_result getResult(I iface, test_args args) throws org.apache.thrift.TException {
        test_result result = new test_result();
        result.success = iface.test(args.id, args.name);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class test<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, test_args, String> {
      ...
      public void start(I iface, test_args args, org.apache.thrift.async.AsyncMethodCallback<String> resultHandler) throws TException {
        iface.test(args.id, args.name,resultHandler);
      }
    }
